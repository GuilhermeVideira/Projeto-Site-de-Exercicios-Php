...
<html lang="en">
    <head>
     ...
     <body data-spy="scroll" data-target=".fixed-top">
         ...
         <br><br> <br><br>
         <h1>  <center> Exercicio 09 </center> </h1>
          <div class="quadradoborda">

          <h4> Index do exercicio: </h4> <br>

<h5> 

< form name="cadastro" method="post" action="exemplo.php"> <br>

Estados: <br>

< select name="estados"> <br>

    < option> São Paulo < /option> <br>

    < option> Rio de Janeiro < /option> <br>

    < option> Minas Gerais < /option> <br>

    < option> Bahia < /option> <br>
...
< /form> <br>
       ...
       <h4> Exibição Php: </h4> <br>

       <h5>  
         
       < ?php <br>

echo "< h3> Recuperando os dados < /h3>"; <br>

echo "< b>Estado: < b>" .$_POST ['estados']; <br>
