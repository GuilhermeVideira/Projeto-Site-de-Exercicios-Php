...
<html lang="en">
    <head>
     ...
     <body data-spy="scroll" data-target=".fixed-top">
         ...
         <br><br> <br><br>
         <h1>  <center> Exercicio 05 </center> </h1>
...
 Qual linguagem de programação você connhece? <br>
...
if (isset ($_POST ['asp'])) <br>

{ <br>

    echo "ASP:" .$_POST ['asp']; <br>

    echo "< br>"; <br>

} <br>

if (isset ($_POST ['php'])) <br>
