                     ...
                     <ul class="navbar-nav ml-auto">
                         ...
                         <li class="nav-item dropdown">
                             ...
                             <div class="dropdown-menu" aria-labelledby="dropdown01">
                                 ...
                                 <div class="dropdown-divider"></div>
                                 <a class="dropdown-item page-scroll" href="indexexercicio09.php"> Atualizar </a>
                                 <div class="dropdown-divider"></div>
             ...
             <div class="container">
                 <div class="row">
                     ...
                     <div class="swiper-slide">
                      ...
                      <h1 class="h1-large"> Exercicio 09 </h1>
                        ...
                        <form name="cadastro" method="post" action="EX09.php">

                        <span class="texto01">  
                        <center>   Estados:  </center> <br> 
