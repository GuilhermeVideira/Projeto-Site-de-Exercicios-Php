                     ...
                     <ul class="navbar-nav ml-auto">
                         ...
                         <li class="nav-item dropdown">
                             ...
                             <div class="dropdown-menu" aria-labelledby="dropdown01">
                                 ...
                                 <div class="dropdown-divider"></div>
                                 <a class="dropdown-item page-scroll" href="indexexercicio06.php"> Atualizar </a>
                                 <div class="dropdown-divider"></div>
             ...
             <div class="container">
                 <div class="row">
                     ...
                     <div class="swiper-slide">
                      ...
                      <h1 class="h1-large"> Exercicio 06 </h1>

                            <div class="row">
                            <div class="col-lg-6 col-xl-7">
                             <div class="image-container">
                            <img class="img-fluid" width="1208px" height="200px" src="./images/imagesss/Imagem04.jpeg" alt="Imagem de programação">
                            ...
                            <form name="cadastro" method="post" action="EX06.php">

                            <span class="texto01"> 

                                <center> Estado Civil </center> <br>

                            <input type="radio" name="estadocivil"> Casado <br>

                            <input type="radio" name="estadocivil"> Solteiro <br>
