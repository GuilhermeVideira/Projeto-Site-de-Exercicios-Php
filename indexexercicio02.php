                     ...
                     <ul class="navbar-nav ml-auto">
                         ...
                         <li class="nav-item dropdown">
                             ...
                             <div class="dropdown-menu" aria-labelledby="dropdown01">
                                 ...
                                 <a class="dropdown-item page-scroll" href="indexexercicio02.php"> Atualizar </a>
                                 <div class="dropdown-divider"></div>
             ...
             <div class="container">
                 <div class="row">
                     ...
                     <div class="swiper-slide">
                      ...
                      <h1 class="h1-large"> Exercicio 02 </h1>
                            ...
                            <img class="img-fluid" width="1208px" height="200px" src="./images/imagesss/Imagem04.jpeg" alt="Imagem de programação">
                                ...
                                <!-- EXEMPLO DO EXERCICIO --> 
                                 <form name="cadastro" method="post" action="EX02.php">

                                 <span class="texto01"> 

                                 <center> Exercicio 02 <br> <br> </center> 
